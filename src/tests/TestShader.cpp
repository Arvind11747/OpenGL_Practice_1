...
namespace Tests
{
    glm::mat4 TestShader::SetMVP(glm::mat4 model, glm::mat4 view, glm::mat4 projection)
    {
	...
	void TestShader::OnImGuiRender(std::string windowName)
	{
        {
        ...
        }
        {
            ...
            ImGui::SliderFloat3("cam", &m_CamTranslation.x, -5000.0f, 5000.0f);
            ImGui::End();
        }
        {
